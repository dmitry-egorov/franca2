...
#define if_let1(name0, initializer) let [name0, line_ok] = (initializer); if (line_ok)
#define if_let2(name0, name1, initializer) let [name0, name1, line_ok] = (initializer); if (line_ok)
#define if_let3(name0, name1, name2, initializer) let [name0, name1, name2, line_ok] = (initializer); if (line_ok)
#define if_let4(name0, name1, name2, name3, initializer) let [name0, name1, name2, name3, line_ok] = (initializer); if (line_ok)

#define if_set1(name0, initializer) let [line_res, line_ok] = (initializer); if (line_ok) { name0 = line_res; } if (line_ok)
